...
class ChatbotState(TypedDict):
    messages: Annotated[list, add_messages]           # All user messages in the conversation
    current_user_query: str            # The latest user query
    current_topic: str                 # The topic for research (if any)
    needs_research: bool   
